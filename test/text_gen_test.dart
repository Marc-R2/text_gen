...
void main() {
  group('integration', () {
    ...
    group('Capsule - Simple', () {
      ...
      test('Random(0)', () => expect(cap.buildVariant(0), 'ABC DEF HIJ'));
    ...
    group('Capsule.permutation', () {
      group('1 List', () {
        ...
        test('1 List(0)', () {
          final res = Capsule.permutation(0, [list]);
          expect(res, ['A']);
        });

        test('1 List(1)', () {
          final res = Capsule.permutation(1, [list]);
          expect(res, ['B']);
        });

        test('1 List(2)', () {
          final res = Capsule.permutation(2, [list]);
          expect(res, ['C']);
        });
      });
      ...
      group('2 Lists', () {
        ...
        test('2 Lists(0)', () {
          final res = Capsule.permutation(0, [list1, list2]);
          expect(res, ['A', 'D']);
        });

        test('2 Lists(1)', () {
          final res = Capsule.permutation(1, [list1, list2]);
          expect(res, ['B', 'D']);
        });

        test('2 Lists(2)', () {
          final res = Capsule.permutation(2, [list1, list2]);
          expect(res, ['C', 'D']);
        });

        test('2 Lists(3)', () {
          final res = Capsule.permutation(3, [list1, list2]);
          expect(res, ['A', 'E']);
        });

        test('2 Lists(4)', () {
          final res = Capsule.permutation(4, [list1, list2]);
          expect(res, ['B', 'E']);
        });

        test('2 Lists(5)', () {
          final res = Capsule.permutation(5, [list1, list2]);
          expect(res, ['C', 'E']);
        });

        test('2 Lists(6)', () {
          final res = Capsule.permutation(6, [list1, list2]);
          expect(res, ['A', 'F']);
        });

        test('2 Lists(7)', () {
          final res = Capsule.permutation(7, [list1, list2]);
          expect(res, ['B', 'F']);
        });

        test('2 Lists(8)', () {
          final res = Capsule.permutation(8, [list1, list2]);
          expect(res, ['C', 'F']);
        });

        test('2 Lists(9)', () {
          final res = Capsule.permutation(9, [list1, list2]);
          expect(res, ['A', 'D']);
        });
      });
      ...
      group('3 Lists', () {
        ...
        test('3 Lists(0)', () {
          final res = Capsule.permutation(0, [list1, list2, list3]);
          expect(res, ['A', 'D', 'G']);
        });

        test('3 Lists(1)', () {
          final res = Capsule.permutation(1, [list1, list2, list3]);
          expect(res, ['B', 'D', 'G']);
        });

        test('3 Lists(2)', () {
          final res = Capsule.permutation(2, [list1, list2, list3]);
          expect(res, ['C', 'D', 'G']);
        });

        test('3 Lists(3)', () {
          final res = Capsule.permutation(3, [list1, list2, list3]);
          expect(res, ['A', 'E', 'G']);
        });

        test('3 Lists(4)', () {
          final res = Capsule.permutation(4, [list1, list2, list3]);
          expect(res, ['B', 'E', 'G']);
        });

        test('3 Lists(5)', () {
          final res = Capsule.permutation(5, [list1, list2, list3]);
          expect(res, ['C', 'E', 'G']);
        });

        test('3 Lists(6)', () {
          final res = Capsule.permutation(6, [list1, list2, list3]);
          expect(res, ['A', 'F', 'G']);
        });

        test('3 Lists(7)', () {
          final res = Capsule.permutation(7, [list1, list2, list3]);
          expect(res, ['B', 'F', 'G']);
        });

        test('3 Lists(8)', () {
          final res = Capsule.permutation(8, [list1, list2, list3]);
          expect(res, ['C', 'F', 'G']);
        });

        test('3 Lists(9)', () {
          final res = Capsule.permutation(9, [list1, list2, list3]);
          expect(res, ['A', 'D', 'H']);
        });

        test('3 Lists(10)', () {
          final res = Capsule.permutation(10, [list1, list2, list3]);
          expect(res, ['B', 'D', 'H']);
        });

        test('3 Lists(11)', () {
          final res = Capsule.permutation(11, [list1, list2, list3]);
          expect(res, ['C', 'D', 'H']);
        });

        test('3 Lists(12)', () {
          final res = Capsule.permutation(12, [list1, list2, list3]);
          expect(res, ['A', 'E', 'H']);
        });

        test('3 Lists(13)', () {
          final res = Capsule.permutation(13, [list1, list2, list3]);
          expect(res, ['B', 'E', 'H']);
        });

        test('3 Lists(14)', () {
          final res = Capsule.permutation(14, [list1, list2, list3]);
          expect(res, ['C', 'E', 'H']);
        });

        test('3 Lists(15)', () {
          final res = Capsule.permutation(15, [list1, list2, list3]);
          expect(res, ['A', 'F', 'H']);
        });

        test('3 Lists(16)', () {
          final res = Capsule.permutation(16, [list1, list2, list3]);
          expect(res, ['B', 'F', 'H']);
        });

        test('3 Lists(17)', () {
          final res = Capsule.permutation(17, [list1, list2, list3]);
          expect(res, ['C', 'F', 'H']);
        });

        test('3 Lists(18)', () {
          final res = Capsule.permutation(18, [list1, list2, list3]);
          expect(res, ['A', 'D', 'I']);
        });

        test('3 Lists(19)', () {
          final res = Capsule.permutation(19, [list1, list2, list3]);
          expect(res, ['B', 'D', 'I']);
        });

        test('3 Lists(20)', () {
          final res = Capsule.permutation(20, [list1, list2, list3]);
          expect(res, ['C', 'D', 'I']);
        });

        test('3 Lists(21)', () {
          final res = Capsule.permutation(21, [list1, list2, list3]);
          expect(res, ['A', 'E', 'I']);
        });

        test('3 Lists(22)', () {
          final res = Capsule.permutation(22, [list1, list2, list3]);
          expect(res, ['B', 'E', 'I']);
        });

        test('3 Lists(23)', () {
          final res = Capsule.permutation(23, [list1, list2, list3]);
          expect(res, ['C', 'E', 'I']);
        });

        test('3 Lists(24)', () {
          final res = Capsule.permutation(24, [list1, list2, list3]);
          expect(res, ['A', 'F', 'I']);
        });

        test('3 Lists(25)', () {
          final res = Capsule.permutation(25, [list1, list2, list3]);
          expect(res, ['B', 'F', 'I']);
        });

        test('3 Lists(26)', () {
          final res = Capsule.permutation(26, [list1, list2, list3]);
          expect(res, ['C', 'F', 'I']);
        });

        test('3 Lists(27)', () {
          final res = Capsule.permutation(27, [list1, list2, list3]);
          expect(res, ['A', 'D', 'G']);
        });
      });
    });
